 ...
 */
@Transactional
public interface ProductBackSupplierService extends OpenmrsService {
	...
	@Authorized(value = {PrivilegeConstants.SAVE_PRODUCT_BACK_SUPPLIER})
	...
	@Authorized(value = {PrivilegeConstants.DELETE_PRODUCT_BACK_SUPPLIER})
