...
public class MovementEntrySearchCriteria extends OperationSearchCriteria {
    public MovementEntrySearchCriteria(Location location, Date fromDate, Date toDate,
