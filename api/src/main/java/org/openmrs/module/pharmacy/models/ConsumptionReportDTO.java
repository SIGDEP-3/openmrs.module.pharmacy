...
public class ConsumptionReportDTO {
    ...
    private List<LocationProductQuantity> locationProductQuantities = new ArrayList<>();
    ...
    public List<LocationProductQuantity> getLocationProductQuantities() {
        return locationProductQuantities;
    }

    public void setLocationProductQuantities(List<LocationProductQuantity> locationProductQuantities) {
