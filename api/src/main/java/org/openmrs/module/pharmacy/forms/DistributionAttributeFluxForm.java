...
public class DistributionAttributeFluxForm extends ProductAttributeFluxForm {
    ...
    public List<ProductAttributeOtherFlux> getAllOtherFluxes() {
        ...
        if (product != null) {
            otherFluxes.add(createProductAttributeOtherFlux(product, getInitialQuantity().doubleValue(), "SI"));
            ...
            otherFluxes.add(createProductAttributeOtherFlux(product, getQuantityDistributed1monthAgo().doubleValue(), "DM1"));
            otherFluxes.add(createProductAttributeOtherFlux(product, getQuantityDistributed2monthAgo().doubleValue(), "DM2"));
        }
