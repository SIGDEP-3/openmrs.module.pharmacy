    ...
    <div class="row bg-light pt-2 pb-2 border border-secondary">
        <div class="col-12">
            <form:form modelAttribute="productDispensationForm" method="post" action="" id="form">
                ...
                <form:hidden path="dispensationStartDate"/>
                <form:hidden path="productProgramId"/>
<%--                <c:if test="${fct:length(productDispensation.productAttributeFluxes) != 0}">--%>
<%--                    <form:hidden path="productProgramId"/>--%>
<%--                </c:if>--%>
                <div class="row">
                    <div class="col-6">
...
<%--                                </c:if>--%>
                    ...
                    <div class="col-6">
                        <div class="row mb-2">
                            <div class="col-5">
                                <label class="mb-1">Date du dernier dispensation</label>
                                <div class="form-control form-control-sm bg-info">
                                    <c:if test="${latestDispensation != null}">
                                        ${lastDispensation.operationDate}
                                    </c:if>
                                    <c:if test="${latestDispensation == null}">
                                        C'est votre premier dispensation
                                    </c:if>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="row mb-2">
                            <div class="col-4">
                                <label>Date de l'dispensation <span class="required">*</span></label>
                    ...
                    <div class="col-6">
                        <div class="row mb-2">
                            <div class="col-4">
                                <label>Num&eacute;ro d'dispensation <span class="required">*</span></label>
                    ...
                    <div class="col-6">
                        <div class="row">
                            <div class="col-10">
                                ...
                                <form:radiobutton path="dispensationType" value="PARTIAL" label=" Partiel" cssClass=""/>
                                <form:radiobutton path="dispensationType" value="FULL" label=" Complet" cssClass=""/>
                ...
                <div class="row">
                    <div class="col-12">
                        <c:if test="${not empty productDispensationForm.productOperationId}">
                            <button class="btn btn-success" onclick="saveOnly(event)">
                                <i class="fa fa-save"></i> Modifier
                            </button>
                        </c:if>
                        <c:if test="${ empty productDispensationForm.productOperationId}">
                            <button class="btn btn-success" onclick="saveOnly(event)">
