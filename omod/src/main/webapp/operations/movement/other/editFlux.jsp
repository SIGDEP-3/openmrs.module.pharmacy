...
<script>
    if (jQuery) {
        ...
        function goToSelectedProduct() {
            ...
            if (productId) {
                location.href = '${pageContext.request.contextPath}/module/pharmacy/operations/movement/other/editFlux.form?' +
        ...
        <div class="col-6 text-right">
            <c:if test="${productMovement.operationStatus != 'VALIDATED' &&
                ...
                <c:if test="${productMovement.operationStatus == 'NOT_COMPLETED' && fct:length(productAttributeFluxes) != 0}">
                    <c:url value="/module/pharmacy/operations/movement/other/complete.form" var="completeUrl">
                ...
                <c:if test="${productMovement.operationStatus != 'NOT_COMPLETED'}">
                    <c:url value="/module/pharmacy/operations/movement/other/incomplete.form" var="incompleteUrl">
                        <c:param name="movementId" value="${productMovement.productOperationId}"/>
                        <c:param name="type" value="${type}"/>
                    </c:url>
                            ...
                            <tr>
                                ...
                                <td>
                                    <c:if test="${productMovement.operationStatus == 'NOT_COMPLETED'}">
                                        ...
                                        <c:url value="/module/pharmacy/operations/movement/other/deleteFlux.form" var="deleteUrl">
                                            <c:param name="movementId" value="${productMovement.productOperationId}"/>
                                            <c:param name="fluxId" value="${productFlux.productAttributeFluxId}"/>
                                            <c:param name="type" value="${type}"/>
                                        </c:url>
